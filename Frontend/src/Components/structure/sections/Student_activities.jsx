  ...
  return (
      ...
      <div className="intro-section">
        <h1 className="intro-title">
          <i className="inline-block mb-1 mr-2" />Explore Student Life
        </h1>
        <p className="intro-text">
          Immerse yourself in a diverse range of college activities designed to foster professional growth and personal development. From academic clubs and technical workshops to leadership programs and sports tournaments, these activities provide invaluable opportunities to enhance skills, build networks, and collaborate with peers. Each initiative contributes to a well-rounded experience, preparing students for future challenges while cultivating teamwork, innovation, and leadership. Engage in these enriching opportunities to maximize your college journey.
        </p>
      </div>
